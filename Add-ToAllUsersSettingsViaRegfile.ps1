...
Function copyRegfileSettingsToEveryone($RegfileName, $AnsiMode)
{
    If (-not [string]::IsNullOrEmpty($RegfileName))
    {
        ...
        copyRegfileSettingsToLoggedOffUserProfiles $RegfileName
        copyRegfileSettingsToDefaultUser $RegfileName
    }
}
...
Function copyRegfileSettingsToLoggedOffUserProfiles($RegfileName)
{
    doToAllUsersWithProfileNotLoggedIn "Import-RegistryFile $RegfileName"
}


Function copyRegfileSettingsToDefaultUser($RegfileName)
{
    doToDefaultUser "Import-RegistryFile $RegfileName"
}
